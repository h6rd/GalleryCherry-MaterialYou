...
public final class ItemLibraryGroupBinding implements ViewBinding {
  @NonNull
  ...
  private ItemLibraryGroupBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout item, @NonNull ImageView ivCover, @NonNull ImageView ivFavourite,
      @NonNull ImageView ivRating, @NonNull ImageView ivReorder, @NonNull TextView tvTitle) {
  ...
  @NonNull
  public static ItemLibraryGroupBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemLibraryGroupBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_library_group, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemLibraryGroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLibraryGroupBinding((ConstraintLayout) rootView, item, ivCover, ivFavourite,
          ivRating, ivReorder, tvTitle);
    }
